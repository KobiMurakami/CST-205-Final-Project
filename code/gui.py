...
class ImageEditor(QWidget):
    def __init__(self):
        ...
        leftColumn.setStyleSheet("background-color: #494e57; color: white;")
        ...
        self.widthSpin.setStyleSheet("background-color: white; color: black;")
        ...
        self.heightSpin.setStyleSheet("background-color: white; color: black;")
        ...
        self.rInput.setStyleSheet("background-color: white; color: black;")
        ...
        self.gInput.setStyleSheet("background-color: white; color: black;")
        ...
        self.bInput.setStyleSheet("background-color: white; color: black;")
